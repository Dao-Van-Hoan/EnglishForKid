...
import com.example.englishforkids.Learn.Model.Quest;
...
public class TestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    DatabaseHander db;
    ArrayList<Quest> list_quest;
    int tongCH, tlDung;
    TextView tvdiem, tvCauHoi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.l_test_activity);
    ...
    public void AnhXa() {
        toolbar = (Toolbar) findViewById(R.id.TB_TestActivity);
        tvdiem = findViewById(R.id.tvScore);
        tvCauHoi = findViewById(R.id.tvQuest);
        bt1 = findViewById(R.id.btAns1);
        bt2 = findViewById(R.id.btAns2);
        bt3 = findViewById(R.id.btAns3);
        bt4 = findViewById(R.id.btAns4);
    ...
    public void ALtoLayout() {
        ...
        tvCauHoi.setText(recent_q.getND());
    ...
    public Quest randomQ(ArrayList<Quest> questions) {
        Quest q;
